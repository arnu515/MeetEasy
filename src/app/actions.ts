...
export async function fetchEvents(isoDateString?: string): Promise<{success: false, error: string, error_description: string} | {success: true, data: typeof meetings.$inferSelect[]}> {
